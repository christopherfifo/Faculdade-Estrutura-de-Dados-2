    ...
    do {
        ...
        switch (opcao) {
            case 1: {
                ...
                int resultado;
                if (comTratamentoColisao) {
                    resultado = insereHash_enderecoAberto(ha, al);
                } else {
            ...
            case 2: {
                ...
                int resultado;
                if (comTratamentoColisao) {
                    resultado = buscaHash_enderecoAberto(ha, matricula, &al);
                } else {
                    resultado = buscaHash_semColisao(ha, matricula, &al);
                }
